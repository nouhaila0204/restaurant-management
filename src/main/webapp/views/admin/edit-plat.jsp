...
<head>
    ...
    <title>Modifier Plat - Tablaino Restaurant</title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="top-bar">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page-title">Modifier le Plat</h1>
                    <p class="text-muted mb-0">Modifier les informations du plat</p>
                </div>
        ...
        <div class="content-card">
            <div class="card-header-custom">
                <i class="bi bi-pencil me-2"></i>Modifier le plat
            </div>
            <div class="p-4">
                <% if (plat != null) { %>
                <form method="post" action="<%= contextPath %>/admin/plats">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom"
                                   value="<%= plat.getNom() != null ? plat.getNom() : "" %>" required>
                        </div>
                            ...
                            <select class="form-select" id="categorieId" name="categorieId" required>
                                ...
                                <% if (categories != null) {
                                    ...
                                    <option value="<%= categorie.getId() %>"
                                        <%= (plat.getCategorie() != null && plat.getCategorie().getId().equals(categorie.getId())) ? "selected" : "" %>>
                                        <%= categorie.getNom() %>
                                    </option>
                                <% }
                                } %>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"><%= plat.getDescription() != null ? plat.getDescription() : "" %></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="prix" name="prix"
                                   step="0.01" min="0" value="<%= plat.getPrix() != null ? plat.getPrix() : "" %>" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Statut</label>
                            <div class="form-control bg-light">
                                <span class="badge <%= plat.isDisponible() ? "bg-success" : "bg-secondary" %>">
                                    <%= plat.isDisponible() ? "Disponible" : "Indisponible" %>
                                </span>
                                <small class="text-muted ms-2">
                                    (Modifier via la liste des plats)
                                </small>
                            </div>
                        </div>
                    </div>

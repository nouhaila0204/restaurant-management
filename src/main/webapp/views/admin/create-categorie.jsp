...
<head>
    ...
    <title>Créer une Catégorie - Tablaino Restaurant</title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="top-bar">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="page-subtitle mb-0">Ajouter une nouvelle catégorie de plats</p>
                </div>
                <!-- CORRECTION ICI -->
        ...
        <div class="content-card">
            <div class="card-header-custom">
                <i class="bi bi-tag me-2"></i>Informations de la catégorie
            </div>
            <div class="p-4">
                <!-- CORRECTION ICI -->
                <form method="post" action="<%= contextPath %>/admin/categories">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description"
                                  rows="4" placeholder="Décrivez cette catégorie..."></textarea>
                        <div class="form-text">Optionnel - Décrivez le type de plats que contiendra cette catégorie.</div>
                    </div>
